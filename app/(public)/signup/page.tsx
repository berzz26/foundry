...
import { signup, login } from '@/lib/services/api';
    ...
    <div className="flex min-h-[calc(100vh-100px)] flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-[var(--ink-3)]">
          ...
          <Link href="/login" className="font-medium text-[var(--teal)] hover:text-[var(--teal-dark)] transition-colors">
            Sign in
          </Link>
        </p>
      </div>
        ...
        <div className="bg-[var(--bg)] py-8 px-4 shadow-[var(--shadow-float)] sm:rounded-xl sm:px-10 border border-[var(--border)]">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-[var(--ink-2)]">
                  First name
                </label>
                <div className="mt-1">
                  <input
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-[var(--ink-2)]">
                  Last name
                </label>
                <div className="mt-1">
                  <input
